# Comment détecter automatiquement une anomalie dans la rétine grâce au deep learning ?
...
Les données peuvent êtr téléchargées dépuis : https://amd.grand-challenge.org/
